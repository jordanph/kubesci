...
async fn update_check_run(
    ...
    let check_run = github_installation_client.get_check_run(&update_check_run_request.check_run_id).await?;

    github_installation_client
        .set_check_run_complete(&update_check_run_request.check_run_id, &update_check_run_request, &check_run.name, &check_run.started_at)
        .await?;
